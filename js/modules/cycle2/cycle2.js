	...
	(a.fn.cycle = function(c) {
		...
		(a.fn.cycle.API = {
			...
			preInitSlideshow  : function() {
				var b = this.opts();
				b.API.trigger('cycle-pre-initialize', [
					b
				]);
			...
			postInitSlideshow : function() {
				var b = this.opts();
				b.API.trigger('cycle-post-initialize', [
					b
				]);
				var c = a.fn.cycle.transitions[b.fx];
			...
			initSlideshow     : function() {
				...
				c.API.calcFirstSlide(),
					...
					(c._initialized = !0),
					c.API.updateView(!0),
					c.API.trigger('cycle-initialized', [
						c
					]),
				...
				'string' == a.type(b) && (b = a.trim(b)),
					a(b).each(function() {
						...
						c ? e.container.prepend(d) : e.container.append(d),
							...
							d.data('cycle.opts', b),
							e.API.trigger('cycle-slide-added', [
								e,
								b,
								d
							]);
			...
			stopTransition    : function() {
				...
				a.slides.filter(':animated').length &&
					(a.slides.stop(!1, !0),
					a.API.trigger('cycle-transition-stopped', [
						a
					])),
			...
			updateView        : function(a, b) {
				...
				if (c._initialized) {
					...
					(!a &&
						b !== !0 &&
						(c.API.trigger('cycle-update-view-before', [
							c,
							d,
							e
						]),
						...
						a &&
							c.hideNonActive &&
							c.slides.filter(':not(.' + c.slideActiveClass + ')').css('visibility', 'hidden'),
						0 === c.updateView &&
							setTimeout(function() {
			...
			getComponent      : function(b) {
				...
				return 'string' == typeof d
					? /^\s*[\>|\+|~]/.test(d) ? c.container.find(d) : a(d)
					: d.jquery ? d : a(d);
			},
				...
				: 'string' == a.type(c)
					? this.each(function() {
							...
							return (
								...
								void 0 === f
									? void b.log(
											'slideshow must be initialized before sending commands; "' + d + '" ignored'
										)
									: ((d = 'goto' == d ? 'jump' : d),
										(e = f.API[d]),
										a.isFunction(e)
			...
			a.extend(b.API, {
				...
				stop    : function() {
					...
					clearTimeout(b.timeoutId),
						...
						b.pauseOnHover &&
							(b.pauseOnHover !== !0 && (c = a(b.pauseOnHover)), c.off('mouseenter mouseleave')),
						b.API
							.trigger('cycle-stopped', [
								b
							])
							.log('cycle-stopped');
				},
		...
		a.extend(a.fn.cycle.defaults, { loader: !1 }),
			a(document).on('cycle-bootstrap', function(b, c) {
				function d(b, d) {
					...
					var j = b.length;
					j &&
						(b.css('visibility', 'hidden').appendTo('body').each(function(b) {
							function g() {
								0 === --i && (--j, f(k));
							}
							var i = 0,
		...
		function c(a, b) {
			...
			if (!c.busy || c.manualTrump) {
				...
				c.currSlide != e &&
					...
					(c._tempFx = c.pagerFx),
					c.API.prepareTx(!0, f),
					c.API.trigger('cycle-pager-activated', [
						c,
						a,
						b
					]));
